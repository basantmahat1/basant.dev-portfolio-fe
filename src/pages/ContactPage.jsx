  ...
  return (
    <section className="mx-auto max-w-4xl px-8 py-16">
      <div className="mb-8 text-center">
        ...
        <h1 className="section-title mb-3 text-4xl">Let&apos;s build together</h1>
      </div>

      <div className="shell">
        <div className="glass grid gap-6 p-8 md:grid-cols-3">
          <div className="rounded-2xl border border-[var(--border)] bg-[rgba(255,255,255,0.08)] p-4">
            ...
            <a href="mailto:hello@basant.dev" className="text-sm font-medium text-text-primary">hello@basant.dev</a>
          </div>
