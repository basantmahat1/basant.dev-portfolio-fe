    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-8 py-14">
        ...
        >
          ...
          <h1 className="section-title justify-center text-3xl">All Projects</h1>
        ...
        <div className="mb-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
          ...
          <input
            ...
            className="w-full max-w-xs rounded-md border border-[var(--border)] bg-[color:var(--input-bg)] px-3 py-2 text-sm text-[color:var(--text-primary)] placeholder:text-[color:var(--text-secondary)] outline-none focus:border-tertiary"
          />
        </div>
